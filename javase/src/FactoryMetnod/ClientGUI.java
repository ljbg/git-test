package FactoryMetnod;// This is a client class that uses the factory method pattern
...
public class ClientGUI extends JFrame {
  ...
  public static final String key = "lijunbo";
   ...
   class ButtonListener implements ActionListener {
      public void actionPerformed(ActionEvent ae)  {
		...
		if (ae.getActionCommand().equals(SHOW)) {
            ...
            //加载配置文件
            InputStream resource = ClientGUI.class.getClassLoader().getResourceAsStream("policy.properties");
            try {
                p.load(resource);
                String className = p.getProperty(type);
                System.out.println(className);
                pp =(PolicyProducer) Class.forName(className).newInstance();
